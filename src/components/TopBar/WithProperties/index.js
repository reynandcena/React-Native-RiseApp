...
import { List, Checkbox, Switch, Searchbar, Button } from "react-native-paper";
import "intl";
...
const WithProperties = () => {
  ...
  const togglePropertyModal = () => {
    setpropertyModalVisible(!propertyModalVisible);
  };
  ...
  return (
    <>
      ...
      <Modal
        isVisible={propertyModalVisible}
        style={{ margin: 0 }}
        animationIn="slideInRight"
        animationOut="slideOutRight"
        animationInTiming={500}
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.headerModal}>
            ...
            <Text style={styles.headerModalText}>Property</Text>
          </View>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.switchContainer}>
              <Switch
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.rowContainer}>
          <TouchableOpacity
            style={[styles.actions, { marginRight: 8 }]}
            onPress={togglePropertyModal}
          >
            <MaterialCommunityIcons name="eye" size={18} style={styles.icon} />
          </TouchableOpacity>
          ...
          <View style={styles.topBarIconContainer}>
            ...
            <TouchableOpacity
              style={styles.actions}
              onPress={() =>
                navigation.navigate("TableViewScreen", { id, title })
              }
            >
              <MaterialIcons
                name="view-headline"
