...
const WorkItemVersion = ({ visibleModal, openModal }) => {
  return (
    <Modal
    ...
    >
      <View style={styles.modalContainer}>
        ...
        <View style={styles.menu}>
          ...
          />
          <View>
            <Text style={styles.menuText}>Work item workflow version: V10</Text>
            <Text style={styles.subMenuText}>
              Published: 13 May 2022, 12:23 PM
            </Text>
          </View>
        </View>
        <View
...
export default WorkItemVersion;
